 ...
 *
	 *instance variable
	 * @param spriteImage   image that represent an object on map as a type Image
	 * @param name  		the name of the player/avatar/iteams  as a type String
	 * @param exist			it's true if the objecet is exit on the map  as a type boolean
	 * @param dialogue		the dialogue between avatars    as a type of string array
	 * @param overlapsWith  it's true if the player is overlaps with an enemy,a iteam , edge or terrains as a type boolean
	 * @param coord			the location includes xCoordinate and yCoordinate  as a type of Location
	 * @param s				it's an object of Sprite      as a type of Sprite
 	*/
	...
	/*
	 * @param exist           the sate of iteams and enemis if they are exist    as a type of boolean
	 */	
	...
	/*
	 * @return exists  		  renew the exist state of iteams and enemies   as a type of boolean 
	 */
	...
	/*
	 * @param overlapsWith     it's true if the player is overlaps with an enemy,a iteam , edge or terrains as a type of boolean
	 */
	...
	/*
	 * return overlapsWith      tell if the player is overlap with something or not , as a type of boolean 
	 */
