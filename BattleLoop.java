...
/**
<<<<<<< HEAD
 * Purpose: This class handles all activity of the fighting sequences in this game.
 * It sets up a fight screen, updates the fight screen, checks to see if a player has won/
 * lost.
 * and it takes in player input for attacks.
 * @author Nathan
 */
