...
public class GameBoard extends GameLoop  {
    ...
    public void createGateArray(ArrayList<Sprite> gate) {
        gate.add(new Sprite("gate", new Location(189,9,0,0),null, '\\',null,true,false));
        gate.add(new Sprite("gate", new Location(190,10,0,0),null, '\\',null,true,false));
        gate.add(new Sprite("gate", new Location(191,11,0,0),null, '\\',null,true,false));
        gate.add(new Sprite("gate", new Location(192,12,0,0),null, '\\',null,true,false));
        gate.add(new Sprite("gate", new Location(193,13,0,0),null, '\\',null,true,false));  
